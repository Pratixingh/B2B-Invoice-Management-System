  ...
  return (
    <div>
      ...
      <Button
        ...
        style={{ marginLeft: '10px', borderRadius: '10px', backgroundColor: 'orange' }}
      >
        Refresh
      </Button>
      <Button
        ...
        color="secondary"
        onClick={handleEdit}
        style={{ marginLeft: '10px', borderRadius: '10px', backgroundColor: 'orange', color : 'white' }}
      ...
      <Button
        ...
        style={{ marginLeft: '10px', borderRadius: '10px', backgroundColor: 'blue' , color : 'white'}}
        disabled={selectedRows.length === 0}
      >
        Predict
      </Button>
      {showDeleteConfirmation && (
        <div className="delete-confirmation">
          <div className="confirmation-message">Are you sure you want to delete the selected rows?</div>
          <div className="confirmation-buttons">
            <button className="confirm-button" onClick={handleDeleteConfirmation}>
              Confirm
            </button>
